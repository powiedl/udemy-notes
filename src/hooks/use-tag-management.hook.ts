import { linkTagToCourseFn, removeTagFromCourseFn } from '#/data/course.data'
import { toggleNoteTagFn } from '#/data/note.data'
import { createAndLinkTagToTargetFn } from '#/data/tag.data'
